...
if __name__ == "__main__":
    ...
    for i in range(len(daily_index_price)):
        ...
        if i==0: #Execute only once at the begining
            # this creates a couple of dicts to keep track of the quantities below. 
        ...
        buyers_numbers, buyers_details,long_call_positions_list,long_put_positions_list=daily_buyers_open(daily_index_price[i],long_call_positions_list,long_put_positions_list)
        sellers_numbers, sellers_details,short_call_positions_list,short_put_positions_list=daily_sellers_open(daily_index_price[i],short_call_positions_list,short_put_positions_list)
